...
| 路径 | 角色 |
|------|------|
| `docs/requirements.md` | **产品唯一真相**（v1.4.5：换皮打架；等级/攻防/能量/进化双条件/XP 缩放） |
...
| `Content/PlayerState/` · `Visual/` · `Accessories/` · 其它 | HenshinPlayer / 脚下能量条 + 经验世界字 / 饰品 / 被动进化；天气场与挖掘为管线（地鼠线消费挖掘） |
...
- **已知缺口：** 无现役 `GrantsPhasing=true`（A11 加成空转）；`WeatherFieldSystem` 无现役招式；联机双端实测 / DPS 抽检 PS7/9/12 / Rage pending。
