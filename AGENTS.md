...
- **饰品（2026-09-10）：** 28 家族逻辑已接线；A01–A28 普通/超级/碎片 64×64 pixeloe。诅咒之符无共鸣；穿墙含 Beam、不含 Field。暴风是 Barrage 穿透弹。戴上即受原版诅咒焰（未变身也烧，超级免疫）。重跑：`python tools/pixelize_accessories.py`。**游戏内图标/合成/掉落验收仍待本地**。
