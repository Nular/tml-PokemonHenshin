	...
	public static class HenshinAccCatalog
	{
		...
		private static AccFamilyDef[] Build() => new[]
		{
			Fam(AccFamilyId.A01, "A01AbilityCapsuleBelt", "特性胶囊", "Ability Capsule", "Bag 特性胶囊 SV Sprite.png", 1, 5,
				...
				s5: new[] { S(AccStat.PassiveEnergyMul, 0.10f) },
			...
			Fam(AccFamilyId.A02, "A02MuscleBand", "力量头带", "Muscle Band", "Bag 力量头带 SV Sprite.png", 3, 6,
				s1: new[] { S(AccStat.DamageBonus, 0.015f) },
				s2: new[] { S(AccStat.DamageBonus, 0.015f) },
				s3: new[] { S(AccStat.DamageBonus, 0.015f) },
				s4: new[] { S(AccStat.DamageBonus, 0.015f) },
				s5: new[] { S(AccStat.DamageBonus, 0.015f) },
				s6: new[] { S(AccStat.CritUpgradeChance, 0.02f) },
				normal: new[] { S(AccStat.DamageBonus, 0.06f) },
				super: new[] { S(AccStat.DamageBonus, 0.12f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A03, "A03SoulDewPendant", "心之水滴", "Soul Dew", "Bag 心之水滴 SV Sprite.png", 4, 7,
				s1: new[] { S(AccStat.AffinityAmp, 0.05f) },
				s2: new[] { S(AccStat.AffinityAmp, 0.05f) },
				s3: new[] { S(AccStat.AffinityAmp, 0.05f) },
				s4: new[] { S(AccStat.AffinityAmp, 0.05f) },
				s5: new[] { S(AccStat.AffinityAmp, 0.05f) },
				s6: new[] { S(AccStat.PsychicDragonDamage, 0.05f) },
				normal: new[] { S(AccStat.AffinityAmp, 0.20f) },
				super: new[] { S(AccStat.AffinityAmp, 0.40f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A04, "A04FloatStoneAnklet", "轻石", "Float Stone", "Bag 轻石 SV Sprite.png", 5, 8,
				s1: new[] { S(AccStat.MoveSpeedBonus, 0.0125f) },
				s2: new[] { S(AccStat.MoveSpeedBonus, 0.0125f) },
				s3: new[] { S(AccStat.FlightEnergySec, 0.25f) },
				s4: new[] { S(AccStat.FlightEnergySec, 0.25f) },
				s5: new[] { S(AccStat.MoveSpeedBonus, 0.0125f) },
				s6: new[] { S(AccStat.FlightEnergySec, 0.25f) },
				normal: new[] { S(AccStat.FlightEnergySec, 1f), S(AccStat.MoveSpeedBonus, 0.05f) },
				super: new[] { S(AccStat.FlightEnergySec, 2f), S(AccStat.MoveSpeedBonus, 0.10f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A05, "A05FocusSashBadge", "气势头带", "Focus Band", "Bag 气势头带 SV Sprite.png", 7, 10,
				...
				s6: new[] { S(AccStat.GuardCutTimer, 30f) },
			...
			Fam(AccFamilyId.A06, "A06LifeOrbCore", "达人带", "Expert Belt", "Bag 达人带 SV Sprite.png", 9, 12,
				s1: new[] { S(AccStat.DamageFactorBonus, 0.0125f) },
				s2: new[] { S(AccStat.DamageFactorBonus, 0.0125f) },
				s3: new[] { S(AccStat.DamageFactorBonus, 0.0125f) },
				s4: new[] { S(AccStat.DamageFactorBonus, 0.0125f) },
				s5: new[] { S(AccStat.DamageFactorBonus, 0.0125f) },
				s6: new[] { S(AccStat.BossDamageBonus, 0.03f) },
				normal: new[] { S(AccStat.DamageFactorBonus, 0.05f) },
				super: new[] { S(AccStat.DamageFactorBonus, 0.10f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A07, "A07CharcoalBag", "木炭", "Charcoal", "Bag 木炭 SV Sprite.png", 2, 5, PokemonType.Fire,
				s1: new[] { S(AccStat.OnFireTargetBonus, 0.02f) },
				s2: new[] { S(AccStat.FireMoveDamage, 0.02f) },
				s3: new[] { S(AccStat.OnFireCritUpgrade, 0.02f) },
				s4: new[] { S(AccStat.OnFireTargetBonus, 0.02f) },
				s5: new[] { S(AccStat.OnFireTargetBonus, 0.02f) },
				s6: new[] { S(AccStat.FireMoveDamage, 0.02f) },
				normal: new[] { S(AccStat.OnFireTargetBonus, 0.08f), S(AccStat.FireMoveDamage, 0.02f), S(AccStat.OnFireCritUpgrade, 0.02f) },
				super: new[] { S(AccStat.OnFireTargetBonus, 0.16f), S(AccStat.FireMoveDamage, 0.04f), S(AccStat.OnFireCritUpgrade, 0.04f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A08, "A08MysticWaterPouch", "神秘水滴", "Mystic Water", "Bag 神秘水滴 SV Sprite.png", 2, 5, PokemonType.Water,
				...
				s5: new[] { S(AccStat.WaterSpeedBonus, 0.025f) },
				s6: new[] { S(AccStat.FlightEnergySec, 0.5f) },
				normal: new[] { S(AccStat.WaterSpeedBonus, 0.10f) },
				super: new[] { S(AccStat.WaterSpeedBonus, 0.20f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A09, "A09MagnetChip", "磁铁", "Magnet", "Bag 磁铁 SV Sprite.png", 4, 7, PokemonType.Electric,
				...
				s6: new[] { S(AccStat.DashSpeedBonus, 1f) },
				normal: new[] { S(AccStat.DashCooldownCut, 0.15f) },
				super: new[] { S(AccStat.DashCooldownCut, 0.30f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A10, "A10SharpBeakMembrane", "锐利鸟嘴", "Sharp Beak", "Bag 锐利鸟嘴 SV Sprite.png", 5, 8, PokemonType.Flying,
				s1: new[] { S(AccStat.FallDmgTakenMul, 0.80f) },
				s2: new[] { S(AccStat.FallDmgTakenMul, 0.80f) },
				s3: new[] { S(AccStat.FallDmgTakenMul, 0.70f) },
				s4: new[] { S(AccStat.FallDmgTakenMul, 0.70f) },
				s5: new[] { S(AccStat.MoveSpeedBonus, 0.02f) },
				s6: new[] { S(AccStat.FlightEnergySec, 0.5f) },
				normal: new[] { S(AccStat.FallDmgTakenMul, 0.25f) },
				super: new[] { S(AccStat.FallDmgTakenMul, 0.10f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A12, "A12DragonFangCharm", "龙之牙", "Dragon Fang", "Bag 龙之牙 SV Sprite.png", 8, 11, PokemonType.Dragon,
				s1: new[] { S(AccStat.BossDamageBonus, 0.015f) },
				s2: new[] { S(AccStat.BossDamageBonus, 0.015f) },
				s3: new[] { S(AccStat.BossDamageBonus, 0.015f) },
				s4: new[] { S(AccStat.BossDamageBonus, 0.015f) },
				s5: new[] { S(AccStat.BossDamageBonus, 0.015f) },
				s6: new[] { S(AccStat.DamageBonus, 0.02f) },
				normal: new[] { S(AccStat.BossDamageBonus, 0.06f) },
				super: new[] { S(AccStat.BossDamageBonus, 0.12f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A14, "A14ChoiceBand", "讲究头带", "Choice Band", "Bag 讲究头带 SV Sprite.png", 4, 7,
				s1: new[] { S(AccStat.ChoiceDamage, 0.125f) },
				s2: new[] { S(AccStat.ChoiceDamage, 0.125f) },
				s3: new[] { F(AccStat.ChoiceLockSkill2) },
				s4: new[] { F(AccStat.ChoiceLockUlt) },
				s5: new[] { S(AccStat.ChoiceDamage, 0.125f) },
				s6: new[] { S(AccStat.ChoiceDamage, 0.125f) },
			...
			Fam(AccFamilyId.A15, "A15ScopeLens", "焦点镜", "Scope Lens", "Bag 焦点镜 SV Sprite.png", 5, 8,
				s1: new[] { S(AccStat.CritUpgradeChance, 0.025f) },
				s2: new[] { S(AccStat.CritUpgradeChance, 0.025f) },
				s3: new[] { S(AccStat.CritUpgradeChance, 0.025f) },
				s4: new[] { S(AccStat.CritUpgradeChance, 0.025f) },
				s5: new[] { S(AccStat.CritUpgradeChance, 0.025f) },
				s6: new[] { S(AccStat.CritUpgradeChance, 0.05f) },
				normal: new[] { S(AccStat.CritUpgradeChance, 0.10f) },
				super: new[] { S(AccStat.CritUpgradeChance, 0.20f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A16, "A16LifeOrb", "生命宝珠", "Life Orb", "Bag 生命宝珠 SV Sprite.png", 5, 8,
				s1: new[] { S(AccStat.LifeOrbDamage, 0.05f) },
				s2: new[] { S(AccStat.LifeOrbDamage, 0.05f) },
				s3: new[] { S(AccStat.LifeOrbDamage, 0.05f) },
				s4: new[] { F(AccStat.LifeOrbHpDrain) },
				s5: new[] { S(AccStat.LifeOrbDamage, 0.05f) },
				s6: new[] { S(AccStat.LifeOrbDamage, 0.05f) },
			...
			Fam(AccFamilyId.A17, "A17ShellBell", "贝壳之铃", "Shell Bell", "Bag 贝壳之铃 SV Sprite.png", 4, 7,
				s1: new[] { S(AccStat.ShellBellHeal, 1f), S(AccStat.ShellBellCdTicks, 30f) },
				s2: new[] { S(AccStat.ShellBellHeal, 1f), S(AccStat.ShellBellCdTicks, 30f) },
				s3: new[] { S(AccStat.ShellBellCdTicks, 25f) },
				s4: new[] { S(AccStat.ShellBellCdTicks, 25f) },
				s5: new[] { S(AccStat.ShellBellHeal, 1f) },
				s6: new[] { S(AccStat.ShellBellCdTicks, 20f) },
				normal: new[] { S(AccStat.ShellBellHeal, 2f), S(AccStat.ShellBellCdTicks, 30f) },
				super: new[] { S(AccStat.ShellBellHeal, 4f), S(AccStat.ShellBellCdTicks, 15f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A18, "A18RockyHelmet", "凸凸头盔", "Rocky Helmet", "Bag 凸凸头盔 SV Sprite.png", 6, 9,
				s1: new[] { S(AccStat.RockyHelmetScale, 0.25f), S(AccStat.RockyHelmetCdTicks, 45f) },
				s2: new[] { S(AccStat.RockyHelmetScale, 0.25f), S(AccStat.RockyHelmetCdTicks, 45f) },
				s3: new[] { S(AccStat.RockyHelmetScale, 0.25f), S(AccStat.RockyHelmetCdTicks, 45f) },
				s4: new[] { S(AccStat.RockyHelmetScale, 0.25f), S(AccStat.RockyHelmetCdTicks, 45f) },
				s5: new[] { S(AccStat.RockyHelmetScale, 0.25f) },
				s6: new[] { S(AccStat.RockyHelmetCdTicks, 22f) },
				normal: new[] { S(AccStat.RockyHelmetScale, 1.0f), S(AccStat.RockyHelmetCdTicks, 45f) },
				super: new[] { S(AccStat.RockyHelmetScale, 2.0f), S(AccStat.RockyHelmetCdTicks, 22f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A19, "A19ChargeBelt", "充电电池", "Cell Battery", "Bag 充电电池 SV Sprite.png", 3, 6,
				...
				s6: new[] { S(AccStat.PassiveEnergyMul, 0.25f) },
			...
			Fam(AccFamilyId.A20, "A20EchoPendant", "光之黏土", "Light Clay", "Bag 光之黏土 SV Sprite.png", 6, 9,
				s1: new[] { S(AccStat.UltRetain, 0.05f) },
				s2: new[] { S(AccStat.UltRetain, 0.05f) },
				s3: new[] { S(AccStat.UltRetain, 0.05f) },
				s4: new[] { S(AccStat.UltRetain, 0.05f) },
				s5: new[] { S(AccStat.UltRetain, 0.05f) },
				s6: new[] { S(AccStat.CooldownCut, 0.02f) },
				normal: new[] { S(AccStat.UltRetain, 0.20f) },
				super: new[] { S(AccStat.UltRetain, 0.40f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A21, "A21BurstArmband", "弱点保险", "Weakness Policy", "Bag 弱点保险 SV Sprite.png", 7, 10,
				s1: new[] { S(AccStat.UltDamageBonus, 0.0625f) },
				s2: new[] { S(AccStat.UltDamageBonus, 0.0625f) },
				s3: new[] { S(AccStat.UltDamageBonus, 0.0625f) },
				s4: new[] { S(AccStat.EnergyGainMul, 0.80f) },
				s5: new[] { S(AccStat.UltDamageBonus, 0.0625f) },
				s6: new[] { S(AccStat.EnergyGainMul, 0.90f) },
				normal: new[] { S(AccStat.UltDamageBonus, 0.25f), S(AccStat.EnergyGainMul, 0.80f) },
				super: new[] { S(AccStat.UltDamageBonus, 0.50f), S(AccStat.EnergyGainMul, 0.60f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A24, "A24Everstone", "不变之石", "Everstone", "Bag 不变之石 SV Sprite.png", 1, 4, untransformed: true,
				...
				super: new[] { F(AccStat.EverstoneBlock), S(AccStat.IncomingCut, 0.04f), S(AccStat.EvioliteDefMul, 0.06f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A25, "A25BlackBelt", "黑带", "Black Belt", "Bag 黑带 SV Sprite.png", 3, 6,
				s1: new[] { S(AccStat.MeleeDeliveryDamage, 0.03f) },
				s2: new[] { S(AccStat.MeleeDeliveryDamage, 0.03f) },
				s3: new[] { S(AccStat.LungeCooldownCut, 0.075f) },
				s4: new[] { S(AccStat.LungeCooldownCut, 0.075f) },
				s5: new[] { S(AccStat.MeleeDeliveryDamage, 0.03f) },
				s6: new[] { S(AccStat.LungeIFrameBonus, 5f) },
				normal: new[] { S(AccStat.MeleeDeliveryDamage, 0.12f), S(AccStat.LungeCooldownCut, 0.15f) },
				super: new[] { S(AccStat.MeleeDeliveryDamage, 0.24f), S(AccStat.LungeCooldownCut, 0.30f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A26, "A26Leftovers", "吃剩的东西", "Leftovers", "Bag 吃剩的东西 SV Sprite.png", 3, 6,
				s1: new[] { S(AccStat.LeftoversHpPerSec, 0.25f) },
				s2: new[] { S(AccStat.LeftoversHpPerSec, 0.25f) },
				s3: new[] { S(AccStat.LeftoversHpPerSec, 0.25f) },
				s4: new[] { S(AccStat.LeftoversHpPerSec, 0.25f) },
				s5: new[] { S(AccStat.LeftoversHpPerSec, 0.25f) },
				s6: new[] { S(AccStat.LeftoversLowHpBonus, 0.25f) },
				normal: new[] { S(AccStat.LeftoversHpPerSec, 1.0f) },
				super: new[] { S(AccStat.LeftoversHpPerSec, 2.0f) },
				loot: new[]
				{
			...
			Fam(AccFamilyId.A28, "A28Eviolite", "进化奇石", "Eviolite", "Bag 进化奇石 SV Sprite.png", 4, 7,
				...
				s6: new[] { S(AccStat.EvioliteDamage, 0.03f) },
				normal: new[] { S(AccStat.EvioliteDefMul, 0.20f) },
				super: new[] { S(AccStat.EvioliteDefMul, 0.40f) },
				loot: new[]
				{
