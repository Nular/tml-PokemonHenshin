...
**现役代码（2026-09-10）：** 36 形态 + A01–A28（碎片/普通/超级）；被动+技能1/2+能量大招；**v1.4 已接线**（含龙之波动爆炸碎片命中 `1×Factor`）；**神奇糖果**已接线（合成 / 第一格 +1 级 / Boss 5%）。游戏内 DPS 抽检、联机双端、饰品图标/合成/掉落、糖果与属性面板验收仍待本地。
