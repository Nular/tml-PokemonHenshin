...
**现役代码（2026-09-11）：** 36 形态 + A01–A28（碎片/普通/超级）；被动+技能1/2+能量大招；**v1.4 已接线**（含龙之波动爆炸碎片命中 `1×Factor`；广角镜按档菱形索敌见需求 §6）；**神奇糖果**已接线；御三家建角发放 + 旧档补发（需求 §4.4，进世界已本地验收）；属性面板在图鉴按钮下方。游戏内 DPS 抽检、联机双端、饰品图标/合成/掉落/索敌与糖果验收仍待本地。

**下一步：** 游戏内验饰品（含新图标）与神奇糖果 → 联机双端实测 → DPS 对标 PS7/9/12 → Rage。调试 `/henshin stage`、`/henshin evolve`、`/henshin stats`、`/henshin setlevel`。
